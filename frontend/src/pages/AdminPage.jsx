...
const AdminPage = () => {
  return (
    <div className='h-screen w-full flex'>
      ...
      <NavLink to="/admin/category" className={({isActive})=>`${isActive ?" bg-gray-400 ":""}  hover:bg-gray-300 hover:text-gray-500 h-10 w-full flex justify-center items-center text-3xl`}>Category</NavLink>
